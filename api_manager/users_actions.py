...
async def users_add_user(data: ticketing_model.UsersAddUserParams):
    ...
    try:
        ...
        email_sent = await send_plain_email(data.email, fm,password)#sending email with random password
...
# pip install pyjwt regex pwdlib[argon2] bcrypt fastapi_mail passlib


# {
#   "email": "hritikkumar@gmail.com",
#   "password": "663890"
# }


# {
#   "email": "nanirakesh8688@gmail.com",
#   "password": "020a2c"
# }